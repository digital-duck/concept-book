(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))o(l);new MutationObserver(l=>{for(const n of l)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(l){const n={};return l.integrity&&(n.integrity=l.integrity),l.referrerPolicy&&(n.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?n.credentials="include":l.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(l){if(l.ep)return;l.ep=!0;const n=a(l);fetch(l.href,n)}})();const S={};function A(t,e){S[t]=e}function re(t){window.location.hash=t}function Y(){var o,l,n;const t=window.location.hash.slice(1)||"/",e=t.match(/^\/domain\/([^?]+)/);if(e){(o=S["/domain/:id"])==null||o.call(S,{id:decodeURIComponent(e[1])});return}const a=t.match(/^\/book(\?.*)?$/);if(a){const r=a[1]||"",u=Object.fromEntries(new URLSearchParams(r.slice(1)));(l=S["/book"])==null||l.call(S,u);return}(n=S[t])==null||n.call(S,{})}function de(){window.addEventListener("hashchange",Y),Y()}let z=null;async function G(){if(z)return z;const t=await fetch("/concept-book/domains/catalog.json");if(!t.ok)throw new Error(`Failed to load catalog: ${t.status}`);return z=await t.json(),z}const Z={en:{"app.title":"ConceptBook","app.tagline":"Explore knowledge through concept graphs","nav.graph":"Graph","nav.content":"Content","nav.about":"About","nav.settings":"Settings","home.subtitle":"Choose a domain to explore","home.filter.all":"All","home.filter.level":"Level","card.nodes":"nodes","card.edges":"edges","card.explore":"Explore Concept-Graph","card.read":"Read book","domain.back":"← Back","domain.openFullscreen":"Open fullscreen","about.title":"About concept-book",loading:"Loading…"}};let X=localStorage.getItem("cb-lang")||"en";function T(t){return(Z[X]||Z.en)[t]??t}function pe(t){X=t,localStorage.setItem("cb-lang",t)}function oe(){return X}function ue(t){const e=document.createElement("article");e.className="cb-card";const a=(t.tags||[]).map(o=>`<span class="cb-tag" data-tag="${o}">${o}</span>`).join("");return e.innerHTML=`
  ...
  `,e.querySelector(".js-explore").addEventListener("click",()=>{re(`/domain/${t.id}`)}),e}const ae=[{code:"en",label:"English"},{code:"zh",label:"中文 (Chinese)"},{code:"es",label:"Español (Spanish)"},{code:"fr",label:"Français (French)"},{code:"de",label:"Deutsch (German)"},{code:"ja",label:"日本語 (Japanese)"},{code:"ko",label:"한국어 (Korean)"},{code:"pt",label:"Português (Portuguese)"},{code:"ar",label:"العربية (Arabic)"},{code:"hi",label:"हिन्दी (Hindi)"}];function me(){const t=document.createElement("select");t.className="cb-lang-picker",t.title="Content language";const e=oe();return ae.forEach(({code:a,label:o})=>{const l=document.createElement("option");l.value=a,l.textContent=o,a===e&&(l.selected=!0),t.appendChild(l)}),t.addEventListener("change",()=>pe(t.value)),t}function P({domainName:t=""}={}){const e=document.createElement("header");e.className="cb-header";const a=document.createElement("div");a.className="cb-header__top";const o=document.createElement("a");if(o.className="cb-header__logo",o.href="#/",o.textContent=T("app.title"),a.appendChild(o),t){const s=document.createElement("span");s.className="cb-header__sep",s.textContent="›",a.appendChild(s);const h=document.createElement("span");h.className="cb-header__domain",h.textContent=t,a.appendChild(h)}const l=document.createElement("span");l.className="cb-header__spacer",a.appendChild(l);const n=document.createElement("nav");n.className="cb-header__nav";const r=document.createElement("a");r.href="#/graph",r.textContent=T("nav.graph"),n.appendChild(r);const u=document.createElement("a");u.href="#/book",u.textContent=T("nav.content"),n.appendChild(u);const c=document.createElement("a");c.href="#/settings",c.textContent=T("nav.settings"),n.appendChild(c),n.appendChild(me());const d=document.createElement("a");return d.href="#/about",d.textContent=T("nav.about"),n.appendChild(d),a.appendChild(n),e.appendChild(a),e}async function be(t){t.innerHTML="",t.appendChild(P());const e=document.createElement("main");e.className="cb-home",e.innerHTML=`<p class="cb-loading">${T("loading")}</p>`,t.appendChild(e);let a;try{a=await G()}catch(c){e.innerHTML=`<p class="cb-error">Could not load domains. ${c.message}</p>`;return}const o=[...new Set(a.flatMap(c=>c.tags))].sort(),l=["intro","core","college","research"];let n="all",r="all";function u(){let c=a;n!=="all"&&(c=c.filter(s=>s.tags.includes(n))),r!=="all"&&(c=c.filter(s=>s.default_level===r)),e.innerHTML=`
    ...
    `;const d=e.querySelector(".cb-card-grid");c.forEach(s=>d.appendChild(ue(s))),e.querySelectorAll(".cb-filter-btn[data-tag]").forEach(s=>{s.addEventListener("click",()=>{n=s.dataset.tag,u()})}),e.querySelector("#cb-level-filter").addEventListener("change",s=>{r=s.target.value,u()})}u()}const fe=[{code:"en",label:"English"},{code:"zh",label:"中文"},{code:"es",label:"Español"},{code:"fr",label:"Français"},{code:"de",label:"Deutsch"},{code:"ja",label:"日本語"},{code:"ko",label:"한국어"},{code:"pt",label:"Português"},{code:"ar",label:"العربية"},{code:"hi",label:"हिन्दी"}],he=["intro","core","college","research"];function ge(t,e){const a={};(e||[]).forEach(l=>{if(!l.name||!l.file)return;const n=a[l.name];(!n||n.model&&!l.model)&&(a[l.name]={file:l.file,model:l.model})});const o={};return Object.keys(a).forEach(l=>{o[l]=`/concept-book/domains/${t}/${a[l].file}`}),o}function ve(t,{level:e="intro",lang:a="en"}={}){const{id:o,books:l=[],generated_concepts:n=[],capstone:r}=t,u=document.createElement("div");u.className="cb-graph-viewer";const c=document.createElement("iframe");return c.className="cb-graph-viewer__frame",c.src=`/concept-book/domains/${o}/output/graph.html`,c.title=`${o} concept graph`,c.setAttribute("allowfullscreen",""),c.addEventListener("load",()=>{var d;try{const s=c.contentWindow;if(!s)return;s.eval("window.__cb_RAW = RAW; window.__cb_nodeIndex = nodeIndex"),s.__cb_CONCEPTS_BASE=`/concept-book/domains/${o}/output/${e}.${a}/html/`,s.__cb_CONCEPT_URLS=ge(o,n);const h=(((d=s.__cb_RAW)==null?void 0:d.nodes)||[]).map(b=>({id:b.id,label:b.label,kind:b.kind,tier:b.tier??0}));window.dispatchEvent(new CustomEvent("cb:graphLoaded",{detail:{concepts:h}}));const _=s.handleSelect;s.handleSelect=function(b){var p;_.call(s,b);const v=(p=s.__cb_nodeIndex)==null?void 0:p[b];v&&window.dispatchEvent(new CustomEvent("cb:nodeSelected",{detail:{nodeId:b,node:v}}))},ye(s,c.contentDocument),xe(s,c.contentDocument,o,l,n,e,a),_e(s,c.contentDocument,o,r,e,a,l)}catch{}}),u.appendChild(c),u.selectNode=d=>{var s,h;try{(h=(s=c.contentWindow)==null?void 0:s.selectNode)==null||h.call(s,d)}catch{}},u}function ye(t,e){if(e.querySelector("#cb-sidebar-theme"))return;const a=e.createElement("style");a.id="cb-sidebar-theme",a.textContent=`
  ...
  `,u.insertAdjacentElement("afterend",d);const s=d.querySelector("#cb-target-sel"),h=d.querySelector("#cb-model-sel"),_=d.querySelector("#cb-level-sel"),b=d.querySelector("#cb-lang-sel"),v=d.querySelector("#cb-skip-cache"),p=d.querySelector("#cb-gen-btn"),m=d.querySelector("#cb-pdf-btn"),g=d.querySelector("#cb-pdf-result"),x=d.querySelector("#cb-gen-log"),y=d.querySelector("#cb-gen-copy");function E(){e.dispatchEvent(new CustomEvent("cb:settings-change",{detail:{level:_.value,lang:b.value}}))}_.addEventListener("change",E),b.addEventListener("change",E),y.addEventListener("click",()=>{navigator.clipboard.writeText(x.textContent).then(()=>{y.textContent="Copied!",setTimeout(()=>{y.textContent="Copy"},1500)})});const i=`cb_gen_target_${a}`,f=(((M=t.__cb_RAW)==null?void 0:M.nodes)||[]).filter(k=>k.kind!=="primitive").sort((k,w)=>k.label.localeCompare(w.label)),C=sessionStorage.getItem(i),L=C&&f.some(k=>k.id===C)?C:o;f.forEach(k=>{const w=e.createElement("option");w.value=k.id,w.textContent=k.label,k.id===L&&(w.selected=!0),s.appendChild(w)}),s.value&&(p.disabled=!1,m.disabled=!1),s.addEventListener("change",()=>{s.value&&sessionStorage.setItem(i,s.value),p.disabled=!s.value,m.disabled=!s.value,m.textContent="PDF",m.style.background="#16a34a",g.style.display="none",g.innerHTML=""}),m.addEventListener("click",async()=>{const k=s.value;if(!k)return;const w=_.value,F=b.value;m.disabled=!0,m.textContent="Generating…",m.style.background="#ea580c";try{const I=`/api/pdf?domain=${encodeURIComponent(a)}&target=${encodeURIComponent(k)}&level=${encodeURIComponent(w)}&language=${encodeURIComponent(F)}`,O=await fetch(I),R=await O.json();if(!O.ok)throw new Error(R.detail||"PDF generation failed");const N=`/concept-book/domains/${a}/${R.file}`;m.textContent="PDF ✓",m.disabled=!1,g.innerHTML=`
        <a href="${N}" download
      ...
      `,g.style.display="flex"}catch(I){m.textContent="Error",m.style.background="#dc2626",m.title=I.message,setTimeout(()=>{m.textContent="PDF",m.style.background="#16a34a",m.disabled=!1},3e3)}}),p.addEventListener("click",()=>{const k=s.value;if(!k)return;sessionStorage.setItem(i,k);const w=h.value,F=_.value,I=b.value,O=v.checked;p.disabled=!0,p.textContent="Generating…",p.style.background="#ea580c",x.style.display="block",y.style.display="block",x.textContent=`▶ target: ${k}  model: ${w}
`;const R=`/api/generate?domain=${encodeURIComponent(a)}&target=${encodeURIComponent(k)}&level=${encodeURIComponent(F)}&language=${encodeURIComponent(I)}&model=${encodeURIComponent(w)}${O?"&skip_cache=true":""}`,$=new t.EventSource(R);$.addEventListener("log",N=>{const{message:ie}=JSON.parse(N.data);x.textContent+=ie+`
`,x.scrollTop=x.scrollHeight}),$.addEventListener("done",()=>{$.close(),x.textContent+=`
✓ Done — reloading…`,setTimeout(()=>t.parent.location.reload(),1200)}),$.addEventListener("gen_error",N=>{$.close(),x.textContent+=`
✗ ${JSON.parse(N.data).message}`,p.disabled=!1,p.textContent="Retry",p.style.background="#dc2626"}),$.onerror=()=>{$.readyState!==t.EventSource.CLOSED&&($.close(),x.textContent+=`
✗ API not reachable.
      ...
      <div class="cb-settings__pair">
        <div class="cb-settings__field">
          ...
          <select id="cb-adapter" class="cb-settings__select">
            ${Object.entries(U).map(([p,m])=>`<option value="${p}">${m.label}</option>`).join("")}
          </select>
        </div>
